...
def parse_args():
    ...
    parser.add_argument("--model", default="mask_rcnn_R_101_DC5_3x.yaml", type=str)
    parser.add_argument("--output_dir", default="checkpoints/deform/R101_DC53x_deform", type=str)
