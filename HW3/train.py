...
def parse_args():
    ...
    parser.add_argument("--json_path", default="data/train.json", type=str)
    ...
    parser.add_argument("--model", default="mask_rcnn_R_50_C4_1x.yaml", type=str)
    parser.add_argument("--output_dir", default="checkpoints/models/R50_C41x", type=str)
...
class TrainerWithBestAP(DefaultTrainer):
    ...
    def build_hooks(self):
        ...
        hooks.append(
            BestCheckpointer(self.cfg.TEST.EVAL_PERIOD, self.checkpointer, "bbox/AP")
        )
        return hooks
