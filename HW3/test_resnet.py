...
def get_parser():
    ...
    parser.add_argument("--output_dir", type=str, default="results/models/X101_FPN3x")
    parser.add_argument("--trained_model", type=str, default="./checkpoints/models/X101_FPN3x")
