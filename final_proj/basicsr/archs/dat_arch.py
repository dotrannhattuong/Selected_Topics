    ...
    def __init__(self, dim, num_heads, reso=64, split_size=[2,4],shift_size=[1,2], expansion_factor=4., qkv_bias=False, qk_scale=None, drop=0.,
        ...
        if b_idx % 2 == 0:
            ...
            self.attn = Adaptive_Spatial_Attention(
                dim, num_heads=num_heads, reso=reso, split_size=[s*self.window_scale[b_idx//2] for s in split_size], shift_size=shift_size, qkv_bias=qkv_bias, qk_scale=qk_scale,
